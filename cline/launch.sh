...
# boot re-auths with a live provider placeholder. The placeholder is a short-lived ES256
# placeholder supplied in-VM by the platform-provided OpenRouter placeholder (signed with the P-256 agent key); a
